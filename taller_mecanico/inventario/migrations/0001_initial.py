...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('STOCK_BAJO', 'Stock Bajo'), ('STOCK_AGOTADO', 'Stock Agotado'), ('STOCK_CRITICO', 'Stock Crítico'), ('REPOSICION_URGENTE', 'Reposición Urgente')], max_length=20)),
                ...
                ('fecha_ultimo_email', models.DateTimeField(blank=True, null=True)),
